__global__ void kernel1(Tensor<float, 2> T0, Tensor<float, 2> T1, Tensor<float, 2> T5) {
  ...
  if (((((blockIdx.x * 64) + ((((ceilDiv(64, 16)) - 1) * 16) + (threadIdx.x / 16))) < 4096) && (((blockIdx.y * 64) + ((((ceilDiv(64, 16)) - 1) * 16) + (threadIdx.x % 16))) < (4096 * 4096)))) {
    for(size_t ki218 = 0; ki218 < (ceilDiv(64, 16)); ++ki218) {
      for(size_t ki219 = 0; ki219 < (ceilDiv(64, 16)); ++ki219) {
        T8[(ki218 * (ceilDiv(64, 16))) + ki219] = 0;
      }
    }
  } else {
    for(size_t ki218 = 0; ki218 < (ceilDiv(64, 16)); ++ki218) {
      for(size_t ki219 = 0; ki219 < (ceilDiv(64, 16)); ++ki219) {
        if (((((blockIdx.x * 64) + ((ki218 * 16) + (threadIdx.x / 16))) < 4096) && (((blockIdx.y * 64) + ((ki219 * 16) + (threadIdx.x % 16))) < (4096 * 4096)))) {
          T8[(ki218 * (ceilDiv(64, 16))) + ki219] = 0;
        }
      }
    }
  ...
  for(size_t ki42 = 0; ki42 < (ceilDiv(4096, 8)); ++ki42) {
    ...
    for(size_t ki48 = 0; ki48 < (ceilDiv((64 * 8), 256)); ++ki48) {
      if (((((blockIdx.x * 64) + (((ki48 * 256) + threadIdx.x) / 8)) < 4096) && (((ki42 * 8) + (((ki48 * 256) + threadIdx.x) % 8)) < 4096))) {
    ...
    for(size_t ki76 = 0; ki76 < (ceilDiv((8 * 64), 256)); ++ki76) {
      if (((((ki42 * 8) + (((ki76 * 256) + threadIdx.x) / 64)) < 4096) && (((blockIdx.y * 64) + (((ki76 * 256) + threadIdx.x) % 64)) < 4096))) {
    ...
    for(size_t ki101 = 0; ki101 < 8; ++ki101) {
      ...
      for(size_t ki112 = 0; ki112 < (ceilDiv(64, 16)); ++ki112) {
        if (((((blockIdx.x * 64) + ((ki112 * 16) + (threadIdx.x / 16))) < 4096) && (((ki42 * 8) + ki101) < 4096))) {
          T6[ki112]
             = T2[(((ki112 * 16) + (threadIdx.x / 16)) * 8) + ki101];
        }
      }
      for(size_t ki147 = 0; ki147 < (ceilDiv(64, 16)); ++ki147) {
        if (((((ki42 * 8) + ki101) < 4096) && (((blockIdx.y * 64) + ((ki147 * 16) + (threadIdx.x % 16))) < 4096))) {
          T7[ki147]
             = T3[(ki101 * 64) + ((ki147 * 16) + (threadIdx.x % 16))];
        }
      }
      if ((((((ki42 * 8) + ki101) < 4096) && (((blockIdx.y * 64) + ((((ceilDiv(64, 16)) - 1) * 16) + (threadIdx.x % 16))) < 4096)) && (((blockIdx.x * 64) + ((((ceilDiv(64, 16)) - 1) * 16) + (threadIdx.x / 16))) < 4096))) {
        ...
        for(size_t ki171 = 0; ki171 < (ceilDiv(64, 16)); ++ki171) {
          for(size_t ki175 = 0; ki175 < (ceilDiv(64, 16)); ++ki175) {
            float T4[1];
            if ((((((blockIdx.x * 64) + ((ki171 * 16) + (threadIdx.x / 16))) < 4096) && (((ki42 * 8) + ki101) < 4096)) && (((blockIdx.y * 64) + ((ki175 * 16) + (threadIdx.x % 16))) < 4096))) {
              T4[0]
                = T6[ki171]
                * T7[ki175];
            }
  ...
  for(size_t ki231 = 0; ki231 < (ceilDiv(64, 16)); ++ki231) {
    for(size_t ki235 = 0; ki235 < (ceilDiv(64, 16)); ++ki235) {
      if (((((blockIdx.x * 64) + ((ki231 * 16) + (threadIdx.x / 16))) < 4096) && (((blockIdx.y * 64) + ((ki235 * 16) + (threadIdx.x % 16))) < 4096))) {
        T9[(((ki231 * 16) + (threadIdx.x / 16)) * 64) + (((((threadIdx.x / 16) + ki235) % (ceilDiv(64, 16))) * 16) + (threadIdx.x % 16))]
  ...
  for(size_t ki247 = 0; ki247 < (ceilDiv((64 * 64), 256)); ++ki247) {
    if (((((blockIdx.x * 64) + (((ki247 * 256) + threadIdx.x) / 64)) < 4096) && (((blockIdx.y * 64) + (((ki247 * 256) + threadIdx.x) % 64)) < 4096))) {
      T5[(((blockIdx.x * 64) + (((ki247 * 256) + threadIdx.x) / 64)) * T5.stride[0]) + ((blockIdx.y * 64) + (((ki247 * 256) + threadIdx.x) % 64))]
         = T9[((((ki247 * 256) + threadIdx.x) / 64) * 64) + ((((((((ki247 * 256) + threadIdx.x) / 64) % 16) + ((((ki247 * 256) + threadIdx.x) % 64) / 16)) % (ceilDiv(64, 16))) * 16) + ((((ki247 * 256) + threadIdx.x) % 64) % 16))];
    }
  }
}
