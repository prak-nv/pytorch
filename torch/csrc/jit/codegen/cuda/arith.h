...
// gt
TORCH_CUDA_API Val* gt(Val* v1, Val* v2);
TORCH_CUDA_API TensorView* gt(TensorView* v1, Val* v2);
TORCH_CUDA_API TensorView* gt(Val* v1, TensorView* v2);
TORCH_CUDA_API TensorView* gt(TensorView* v1, TensorView* v2);
// eq
