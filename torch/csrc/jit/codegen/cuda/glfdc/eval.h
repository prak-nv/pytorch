...
std::unique_ptr<EvalState> createEvalStateForDAG(const ExprDAG& dag);
...
struct ExprEvaluator {
  ...
  // Argument to this function is same unique value for which the binding was created.
  // See ExpressionBuilder::getBinding();
